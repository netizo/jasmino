            ...
            <div className="adv-in">
                <div className="rv">
                    <div className="adv-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--green)" strokeWidth="1.5"
                            dangerouslySetInnerHTML={{ __html: data.advIcon || '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>' }} />
                    </div>
                    <h2 className="adv-h">
                ...
                <div className="adv-visual rv rd2">
                    <div className="adv-diagram">
                        <div dangerouslySetInnerHTML={{ __html: `<svg viewBox="0 0 340 260" fill="none">${data.advantage.diagram}</svg>` }} style={{ width: '100%', height: 'auto', maxHeight: '100%', opacity: 0.85 }} />
                    </div>
                </div>
            </div>
        </section>
