...
export default function HeroScene({ phase }) {
    ...
    useEffect(() => {
      ...
      `
        ...
        const greenAccent = new THREE.PointLight(0x2E8B57, 0, 10);
        greenAccent.position.set(2, 1, 3);
        scene.add(greenAccent);

        const greenAccent2 = new THREE.PointLight(0x2E8B57, 0, 10);
      ...
      `
        ...
        const animate = () => {
            ...
            if (phaseRef.current !== lastPhaseVal) {
                const colors = [new THREE.Color(0x1B4B8F), new THREE.Color(0xc0c8d0), new THREE.Color(0x2E8B57)];
            ...
            if (targetPhase === 0) { // DESIGN
                ...
                apMat.color.lerp(new THREE.Color(0x2E8B57), dt * 3);
