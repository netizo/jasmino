export const infrastructureData = {
  hero: {
    ...
    fallback_image: '/images/infra-01.webp',
    stats: [
  ...
  facilityNav: [
    ...
    { id: 'germany-gbt', flag: '\uD83C\uDDE9\uD83C\uDDEA', label: 'Germany \u2014 GBT' }
  ],

  overview: {
    overline: 'Our Infrastructure',
    title_html: 'Three sites, one <em>supply chain</em>',
    description: 'Each facility is purpose-built for a specific link in the chain. India handles engineering and heavy fabrication. Germany provides European rubber and plastic lining expertise through HAW Linings, and GBT in Germany delivers coating and lining services.',
    stats: [
      { value: '80K', label: 'm\u00B2 India' },
      { value: '30K', label: 'm\u00B2 Germany' },
      { value: '20K', label: 'm\u00B2 Germany (GBT)' },
    ...
    mapPins: [
      ...
      { id: 'germany-gbt', cx: 465, cy: 160, name: 'GBT', meta: '20,000 m\u00B2 \u00B7 Germany', labelX: 475, labelY: 175, labelText: 'GERMANY (GBT)', pulseR: 11, pulseDur: '3.0s' }
    ]
  },
  ...
  facilities: [
    {
      ...
      alt: false,
      gallery: [
        { src: '/images/infra-in-01.webp', alt: 'Main fabrication hall', caption: 'Main Fabrication Hall', sub: 'Heavy Vessel Bay', span2: true },
        { src: '/images/infra-in-02.webp', alt: 'Engineering', caption: 'Engineering', sub: '3D Design Office' },
        { src: '/images/infra-in-03.webp', alt: 'Welding', caption: 'Welding', sub: 'SAW Station' },
        { src: '/images/infra-in-04.webp', alt: 'QA', caption: 'QA/QC', sub: 'Metallurgy Lab' }
      ],
      specs: [
        {
          icon: 'fabrication',
    ...
    },
    {
      ...
      alt: true,
      gallery: [
        { src: '/images/infra-haw-01.webp', alt: 'Rubber lining', caption: 'Rubber Lining Bay', sub: 'Vessel Interior', span2: true },
        { src: '/images/infra-haw-02.webp', alt: 'R&D', caption: 'R&D Lab', sub: 'Compound Testing' },
        { src: '/images/infra-haw-03.webp', alt: 'Surface prep', caption: 'Surface Prep', sub: 'Blast Cleaning' },
        { src: '/images/infra-haw-04.webp', alt: 'Autoclave', caption: 'Curing', sub: 'Autoclave Bay' }
      ],
      specs: [
        {
          icon: 'clock',
    ...
    },
    {
      ...
      name: 'GBT',
      nameAccent: 'Germany',
      description: 'GBT in Germany \u2014 coating and lining services for the European and Middle Eastern markets. Full rubber lining, plastic lining, and coating capabilities with rapid response for shutdown and turnaround services.',
      capacity: { num: '20,000', label: 'm\u00B2 service capacity' },
      alt: false,
      gallery: [
        { src: '/images/infra-gbt-01.webp', alt: 'Application bay', caption: 'Application Bay', sub: 'Epoxy Coating System', span2: true },
        { src: '/images/infra-gbt-02.webp', alt: 'Workshop', caption: 'Workshop', sub: 'Pipe Lining' },
        { src: '/images/infra-gbt-03.webp', alt: 'Field service', caption: 'Field Service', sub: 'On-Site Lining' },
        { src: '/images/infra-gbt-04.webp', alt: 'QC', caption: 'QC', sub: 'Holiday Testing' }
      ],
      specs: [
        {
          icon: 'location',
          title: 'Strategic Hub',
          description: 'Germany location provides access to European, Middle Eastern, and North African markets.',
  ...
  quality: {
    ...
    pillars: [
      ...
      { num: '02', title: 'Cross-Site Audits', description: 'Regular internal audits between facilities. India audits HAW, HAW audits GBT, GBT audits India \u2014 circular accountability across Germany and India.' },
